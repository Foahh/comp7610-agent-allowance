...
export function openBuyerDatabase(filename: string) {
  ...
  function getPurchase(id: string): Purchase | undefined {
    ...
    return {
      ...
      requiredConfirmations: row.requiredConfirmations ?? undefined,
  ...
  function savePurchase(purchase: Purchase) {
    db.transaction((tx) => {
      ...
      const row = {
        ...
        confirmations: purchase.confirmations ?? null,
        requiredConfirmations: purchase.requiredConfirmations ?? null,
