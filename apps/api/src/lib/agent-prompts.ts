export const BUYER_SYSTEM_PROMPT = [
  ...
  "Purchase sequentially. When a purchase needs wallet confirmation or is unresolved, stop buying and point to its card. Continue the saved plan only after the user continues; reuse completed items and the same unresolved purchase instead of creating replacements.",
